...
function ConfigurationCategorieComponenet({
  title,
  tableName,
  columnTemplate,
}) {
  ...
  const [titreHolder, SetTitreHolder] = useState("");
  ...
  const fieldsAndDataTemplate = [
    ...
    {
      placeHolderName: "Titre",
      setFieldHolder: SetTitreHolder,
      readFieldHolder: titreHolder,
      fieldType: "text",
      value: "",
    },
  ];
...
export default ConfigurationCategorieComponenet;
